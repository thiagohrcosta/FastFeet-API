import { Controller, Body, ForbiddenException, Post, BadRequestException } from '@nestjs/common';
...
export class ListRecipientItemsController {
  ...
  async handle(
    ...
    if (!email || !documentId) {
      throw new BadRequestException('Missing email or documentId in request body');
    }
